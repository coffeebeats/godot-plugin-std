...
## What's Changed
* chore(claude): keep `await` out of std by @coffeebeats in https://github.com/coffeebeats/godot-plugin-std/pull/478


**Full Changelog**: https://github.com/coffeebeats/godot-plugin-std/compare/v6.1.2...v6.1.3
...
## What's Changed
* chore: anchor the godot ignore pattern to the repository root by @coffeebeats in https://github.com/coffeebeats/godot-plugin-std/pull/451
* chore: promote default-on GDScript warnings to compile errors by @coffeebeats in https://github.com/coffeebeats/godot-plugin-std/pull/453


**Full Changelog**: https://github.com/coffeebeats/godot-plugin-std/compare/v5.2.2...v5.2.3
...
## What's Changed
* chore(screen): better organize properties on screens and transitions by @coffeebeats in https://github.com/coffeebeats/godot-plugin-std/pull/382
* fix(screen): load scenes and dependencies alongside exit transitions by @coffeebeats in https://github.com/coffeebeats/godot-plugin-std/pull/384


**Full Changelog**: https://github.com/coffeebeats/godot-plugin-std/compare/v4.5.3...v4.5.4
...
* chore(addons): update `GodotSteam` to latest (removes unsupport platform binaries) by @coffeebeats in https://github.com/coffeebeats/godot-plugin-std/pull/319
...
* chore(deps): bump googleapis/release-please-action from 4.3.0 to 4.4.0 by @dependabot[bot] in https://github.com/coffeebeats/godot-plugin-std/pull/301
* chore!: update to Godot `v4.5` by @coffeebeats in https://github.com/coffeebeats/godot-plugin-std/pull/302
* chore(docs): update versions in `README.md` by @coffeebeats in https://github.com/coffeebeats/godot-plugin-std/pull/303


**Full Changelog**: https://github.com/coffeebeats/godot-plugin-std/compare/v2.0.2...v3.0.0

...
func test_config_item_marshal_erases_when_serializing_default_value():
	...
	assert_false(config.has_bool(item.category, &"test_bool"))
	assert_false(config.has_float(item.category, &"test_float"))
	assert_false(config.has_int(item.category, &"test_int"))
	assert_false(config.has_int_list(item.category, &"test_int_list"))
	assert_false(config.has_string(item.category, &"test_string"))
	assert_false(config.has_string_list(item.category, &"test_string_list"))
	assert_false(config.has_vector2(item.category, &"test_vector2"))
	assert_false(config.has_vector2_list(item.category, &"test_vector2_list"))
